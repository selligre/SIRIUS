        ...
        while (!clientRequests.isEmpty()) {
            ...
            for (final Announce announce : announces.getAnnounces()) {
                ...
                asciiTable.addRow(announce.getAnnounce_id(), announce.getRef_author_id(),
                        ...
                        announce.getStatus(), announce.getType(), announce.getTitle(),
                        announce.getDescription(), announce.getDate_time_start(),
                        announce.getDuration(), announce.getDate_time_end(),
                        announce.getIs_recurrent(), announce.getSlots_number(),
                        announce.getSlots_available(), announce.getPrice(),
                        announce.getRef_author_id());
                asciiTable.addRow(announce.getAnnounce_id());
            }
            asciiTable.addRule();
            logger.debug("\n{}\n", asciiTable.render());
        }
