...
public class InsertView extends JPanel {
    ...
    public InsertView() {
        ...
        tfa_description.setBounds(180, 360, 1000, 85);
        lbl_description.setBounds(100, 360, 100, 25);
    ...
    private void checkInputs() {
        ...
        try {
            ...
            String slot_number = checkSlots();
            String slots_available = slot_number;
    ...
    private String checkPrice() {
        logger.info("Checking price");
        double price;
        try {
            price = (double) tf_price.getValue();
        } catch (Exception e) {
            logger.info("Error: Price not mentionned, set it to 0.0");
            price = 0.0;
        }
    ...
    private String checkSlots() {
        ...
        int slots;
        try {
            slots = (Integer) tf_slots.getValue();
        } catch (Exception e) {
            logger.info("Error: Slots not mentionned, set it to -1");
            slots = -1;
        }
